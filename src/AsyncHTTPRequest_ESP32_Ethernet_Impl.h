/****************************************************************************************************************************
  AsyncHTTPRequest_ESP32_Ethernet_Impl.h
...
#ifndef ASYNC_HTTP_REQUEST_ESP32_ETHERNET_IMPL_H
#define ASYNC_HTTP_REQUEST_ESP32_ETHERNET_IMPL_H
...
{
  return String(ASYNC_HTTP_REQUEST_ESP32_ETHERNET_VERSION);
}
...
size_t  AsyncHTTPRequest::_send()
{
  ...
  if ( ! _client->connected())
  {
    // KH fix bug https://github.com/khoih-prog/AsyncHTTPRequest_ESP32_Ethernet/issues/38
